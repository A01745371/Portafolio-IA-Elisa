...
for k in range(4):
  ...
  # Se dividen los datos en un set de entrenamiento, validación y pruebas
...
disp = ConfusionMatrixDisplay(confusion_matrix=cm,display_labels=target_names)
disp.plot()
plt.show() # CAMBIAR RUTA DEL ARCHIVO Airlines.csv
...
for k in range(4):
  ...
  print("Corrida de validación " + str(k+1))

  # Se dividen los datos en un set de entrenamiento y validación
  Xtrain1, X_val, ytrain1, y_val = train_test_split(Xtrain, ytrain, test_size = 0.2)
...
# Se hacen las predicciones con el set de prueba
print("Resultados con set de prueba")
prediction_test = arbol.prediccion(Xtest)
target_names = ['class 0', 'class 1']
print(classification_report(ytest, prediction_test, target_names=target_names))
